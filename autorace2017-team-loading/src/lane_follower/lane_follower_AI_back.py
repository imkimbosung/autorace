...
class Lane_tracer_AI():
    def __init__(self):
       ...
       # self.saver.restore(self.sess, "/home/devel/catkin_ws/src/git_autorace/autorace2017-team-loading/self_driving_turtlebot3/src/lane_follower/model/model.ckpt")
	...
	#print(np_image)
        # graph() just one play but use it after reset .
          # tf.reset_default_graph() this part wonhyeok's fit
